...
function Avatar({ navigation, onEditProfile }: AvatarProps) {
  ...
  const avatars = [
    { id: 1, uri: 'https://rn-taskly-img.s3.sa-east-1.amazonaws.com/avatar1.png', borderColor: '#5B3CC4' },
    { id: 2, uri: 'https://rn-taskly-img.s3.sa-east-1.amazonaws.com/avatar2.png', borderColor: '#E6E0F7' },
    { id: 3, uri: 'https://rn-taskly-img.s3.sa-east-1.amazonaws.com/avatar3.png', borderColor: '#32C25B' },
    { id: 4, uri: 'https://rn-taskly-img.s3.sa-east-1.amazonaws.com/avatar4.png', borderColor: '#FF0000' },
    { id: 5, uri: 'https://rn-taskly-img.s3.sa-east-1.amazonaws.com/avatar5.png', borderColor: '#B58B46' },
  ];
